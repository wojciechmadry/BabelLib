...
namespace babel::GRAPHICS{
    ...
    inline constexpr cmyk RGB_TO_CMYK(const rgb &a_rgb) noexcept
    {
        auto rp = static_cast<double>(a_rgb.R()) / 255.0;
        auto gp = static_cast<double>(a_rgb.G()) / 255.0;
        auto bp = static_cast<double>(a_rgb.B()) / 255.0;
    ...
    inline constexpr rgb CMYK_TO_RGB(const cmyk &a_cmyk) noexcept
    {
        auto c = static_cast<double>(a_cmyk.C()) / 100.0;
        auto m = static_cast<double>(a_cmyk.M()) / 100.0;
        auto y = static_cast<double>(a_cmyk.Y()) / 100.0;
        auto k = static_cast<double>(a_cmyk.K()) / 100.0;
